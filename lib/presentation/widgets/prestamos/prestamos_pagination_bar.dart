...
// PAGINACIÓN
// ══════════════════════════════════════════════════════════════════════════════
class PrestamosPaginationBar extends StatelessWidget {
  final PrestamoState st;
  final PrestamoNotifier ntf;
  const PrestamosPaginationBar({
    super.key,
    required this.st,
    required this.ntf,
  });
      ...
      btns.add(
        AnimatedContainer(
          ...
          child: InkWell(
            ...
            onTap: isCur ? null : () => ntf.cargar(pagina: p),
            child: Container(
              width: 32,
              height: 32,
  ...
  Widget build(BuildContext ctx) {
    ...
    final isMobile =
        ResponsiveUtilsBosque.isMobile(ctx) ||
