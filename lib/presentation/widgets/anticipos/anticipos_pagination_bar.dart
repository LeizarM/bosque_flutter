...
// PAGINACIÓN
// ══════════════════════════════════════════════════════════════════════════════
class AnticiposPaginationBar extends StatelessWidget {
  final AnticipoState st;
  final AnticipoNotifier ntf;
  const AnticiposPaginationBar({
    super.key,
    required this.st,
    required this.ntf,
  });
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(6),
                border: Border.all(
                  color: isCur ? cs.primary : cs.outline.withOpacity(0.25),
                ),
              ),
        ...
        children: [
          ...
          IconButton(
            ...
            icon: Icon(
              ...
              color:
                  st.pagina > 1 ? cs.primary : cs.onSurface.withOpacity(0.25),
            ),
            onPressed:
