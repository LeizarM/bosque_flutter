...
class _FormularioGaranteReferenciaState
        ...
        return Dialog(
          ...
          child: FormularioPersona(
            ...
            onSave: (persona) async {
              try {
                // Guardar la persona
                final newPersona = await ref.read(
                ...
                setState(() {
                  ...
                  _mensajeNuevaPersona =
                      'persona registrada correctamente. Por favor, complete los demas campos.';
                });
              ...
              child: DropdownSearch<PersonaEntity>(
                dropdownDecoratorProps: DropDownDecoratorProps(
                  dropdownSearchDecoration: InputDecoration(
                    ...
                    contentPadding: EdgeInsets.symmetric(
                      horizontal: 16,
                      vertical: ResponsiveUtilsBosque.getVerticalPadding(
                        context,
                      ),
                    ),
                  ),
                ...
                onChanged: (PersonaEntity? persona) {
                  setState(() {
                    ...
                    _mensajeNuevaPersona =
                        null; // Oculta el mensaje si elige otra persona
                  });
                },
                validator:
                    (value) => value == null ? 'Seleccione una persona' : null,
  ...
  Widget _buildTipoGaranteDropdown() {
    return ref
        .watch(obtenerTipoGaranteReferenciaProvider)
        .when(
          data: (tipoGarante) {
            ...
            final value =
                opciones.contains(_tipoGaranteSeleccionado)
            ...
            return DropdownButtonFormField<String>(
              ...
              items:
                  tipoGarante
                      ...
                      .toList(),
              onChanged:
                  (value) => setState(() => _tipoGaranteSeleccionado = value),
              validator:
                  (value) =>
                      validarDropdown(value?.toString(), 'Tipo de garante'),
            );
          },
