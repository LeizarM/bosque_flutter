...
class _TelefonoSectionState extends ConsumerState<TelefonoSection> {
        ...
        children: [
          ...
          telefonosAsync.when(
            data: (telefonos) {
                    ...
                    child: Row(
                      ...
                      children: [
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () async {
                                      await Clipboard.setData(
                                        ClipboardData(text: telefono.telefono),
                                      );
                                      if (context.mounted) {
                        ...
                        if (widget.habilitarEdicion) ...[
                          ...
                          if (widget.selectedOperation['telefono'] ==
                              'eliminar')
                            IconButton(
              ...
              return showScroll
                  ? SizedBox(height: (4 * 48.0) + 16, child: telefonoList)
                  : Column(
                    children:
                        telefonos
                            .map(
            ...
            child: FormularioTelefono(
              ...
              onSave: (telefono) async {
                ...
                final existente = await ref.read(
                  obtenerCorporativoEmpleado((codTipoTel, numero)).future,
                );
  ...
  Future<void> _advertirSiSinTelefonos(
    BuildContext context,
    WidgetRef ref,
