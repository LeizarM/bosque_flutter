...
class PrestamoDashboardScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PrestamoDashboardScreen> createState() =>
      _PrestamoDashboardScreenState();
}

class _PrestamoDashboardScreenState
    extends ConsumerState<PrestamoDashboardScreen> {
...
class _NuevaSolicitudDialogState extends ConsumerState<NuevaSolicitudDialog> {
  ...
  Future<void> _loadUserData() async {
    ...
    try {
      ...
      console('Error loading user data: $e');
      if (mounted) {
        setState(() {
          _isLoadingUserData = false;
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        coches.when(
                          data:
                              (cochesData) => DropdownButtonFormField<int>(
                                isExpanded:
                                    true, // Make dropdown use full width
                                menuMaxHeight:
                                    300, // Limit menu height to prevent overflow
                                decoration: InputDecoration(
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              backgroundColor:
                                  Colors
                                      .green, // Using green as shown in the image
                            ...
                            onPressed:
                                (registroState.isLoading || _isLoadingUserData)
                                    ? null
                                    : () async {
                                      if (_formKey.currentState?.validate() ??
                                          false) {
                                        if (_tipoSolicitudSeleccionado !=
                                                null &&
                                            _cocheSeleccionado != null) {
