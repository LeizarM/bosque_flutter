...
class ControlCombustibleViewScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ControlCombustibleViewScreen> createState() =>
      _ControlCombustibleViewScreenState();
}

class _ControlCombustibleViewScreenState
    extends ConsumerState<ControlCombustibleViewScreen> {
                ...
                Expanded(
                  child: Consumer(
                    builder: (context, ref, _) {
                      final asyncBidonDetalle = ref.watch(
                        listDetalleBidonProvider(idCM),
                      );
                          ...
                          return SingleChildScrollView(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildReportInfo(
                                  'Código Destino',
                                  bidon.codigoDestino.isEmpty
                                      ? 'N/A'
                                      : bidon.codigoDestino,
                                ),
                                _buildReportInfo(
                                  'Fecha',
                                  _formatDate(bidon.fechaMovimiento.toString()),
                                ),
                                _buildReportInfo(
                                  'Litros o Unidad de Ingreso',
                                  '${bidon.valorEntrada.toStringAsFixed(2)} L',
                                ),
                                _buildReportInfo(
                                  'Origen',
                                  bidon.nombreCoche.isEmpty
                                      ? 'N/A'
                                      : bidon.nombreCoche,
                                ),
                                _buildReportInfo(
                                  'Sucursal',
                                  bidon.nombreSucursal.isEmpty
                                      ? 'N/A'
                      ...
                      return asyncCombustibles.when(
                        ...
                        data: (combustibles) {
                          ...
                          if (isMobile) {
                            ...
                            return Column(
                              children:
                                  combustibles.asMap().entries.map((entry) {
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                const SizedBox(width: 4),
                                                Text(
                                                  '${c.kilometraje.toStringAsFixed(0)} km',
                                                  style: TextStyle(
                                                    color:
                                                        colorScheme.onSurface,
                                                  ),
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                const SizedBox(width: 4),
                                                Text(
                                                  'Recorrido: ${c.diferencia.toStringAsFixed(2)} km',
                                                  style: TextStyle(
                                                    color:
                                                        colorScheme.onSurface,
                                                  ),
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: ConstrainedBox(
                                    ...
                                    child: DataTable(
                                      ...
                                      rows: List.generate(combustibles.length, (
                                        index,
                                      ) {
                                        ...
                                        return DataRow(
                                          ...
                                          cells: [
                                            ...
                                            DataCell(
                                              Text(
                                                c.diferencia.toStringAsFixed(2),
                                                style: TextStyle(
                                                  color: colorScheme.onSurface,
                                                ),
                                              ),
