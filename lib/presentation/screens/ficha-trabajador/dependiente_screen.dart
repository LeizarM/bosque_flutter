...
class _DependienteScreenState extends ConsumerState<DependienteScreen> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
              ...
              children: [
                ...
                DropdownButton<String>(
                  ...
                  items: const [
                    ...
                    DropdownMenuItem(
                      value: 'referencias',
                      child: Text('Referencias Laborales'),
                    ),
                  ],
                  onChanged: (value) {
                    if (value != null) {
          ...
          Expanded(
            child:
                _vistaSeleccionada == 'dependientes'
                    ? Consumer(
                          ...
                          data: (dependientes) {
                            ...
                            if (isDesktop) {
                              return _buildDependientesWebView(
                                ...
                                _agregarDependiente,
                                (context, dep) => _editarDependiente(
                                  context: context,
                                  dependiente: dep,
                                ),
                                ...
                                Expanded(
                                  child:
                                      dependientes.isEmpty
                                          ? const Center(
                                            child: Text(
                                              "El empleado no tiene dependientes",
                                            ),
                                          )
                                          : RefreshIndicator(
                                            onRefresh: () async {
                                              ref.invalidate(
                                                dependientesProvider(
                                                  widget.codEmpleado,
                                                ),
                                              );
                ...
                Row(
                  children: [
                    if (habilitarEdicion &&
                        ...
                        (dependiente.empActivo == null ||
                            dependiente.empActivo == 0))
                      IconButton(
                    ...
                    if (habilitarEdicion &&
                        selectedOperation['dependiente'] == 'eliminar')
                      PermissionWidget(
                        buttonName:
                            'btnEliminarReferencia', // Usa el nombre exacto de tu BD
                        child: IconButton(
                  ...
                  children: [
                    ...
                    if (habilitarEdicion)
                      CustomSpeedDial(
                        ...
                        onAgregar:
                            () => _mostrarDialogoAgregarTelefono(dependiente),
                        updateOperation: (String? op) {
                                            ...
                                            children: [
                                              ...
                                              if (selectedOperation['telefono'] ==
                                                ...
                                                IconButton(
                                                  ...
                                                  onPressed:
                                                      () => ConfirmDialog.showConfirmDelete(
                                                        context: context,
                                                        title:
                                                            'Eliminar Teléfono',
                                                        content:
  ...
  Widget _buildDependientesWebView(
    ...
    void Function(BuildContext context, DependienteEntity dependiente)
    onEditarDependiente,
    void Function(
      BuildContext context,
      WidgetRef ref,
                ...
                : Expanded(
                  child: SingleChildScrollView(
                    child: ExpansionPanelList.radio(
                      ...
                      children:
                          dependientes.asMap().entries.map((entry) {
                            ...
                            return ExpansionPanelRadio(
                              ...
                              headerBuilder: (context, isExpanded) {
                                return ListTile(
                                  ...
                                  subtitle: Row(
                                    children: [
                                      Text(
                                        'Parentesco: ${ref.read(parentescosProvider).maybeWhen(data: (tipos) {
                                          final tipo = tipos.firstWhere((t) => t.codTipos == dep.parentesco, orElse: () => ParentescoEntity(codTipos: '', nombre: 'NO DEFINIDO', codGrupo: 0, listTipos: []));
                                          return tipo.nombre.toUpperCase();
                                        }, orElse: () => 'cargando...')}',
                                      ),
                                  ...
                                  trailing: Row(
                                    ...
                                    children: [
                                      ...
                                      PermissionWidget(
                                        buttonName:
                                            'btnEliminarReferencia', // Usa el nombre exacto que tienes en tu BD
                                        child: IconButton(
                                          icon: const Icon(
                                            Icons.delete,
                                            color: Colors.red,
                              ...
                              body: FutureBuilder<PersonaEntity>(
                                future: ref.read(
                                  obtenerPersonaProvider(dep.codPersona).future,
                                ),
                                builder: (context, snapshot) {
                                  if (!snapshot.hasData) {
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Consumer(
                                                      builder: (
                                                        ...
                                                        telefonoScrollController =
                                                            ScrollController();
                                                        final telefonosAsync =
                                                            ref.watch(
                                                              telefonoProvider(
                                                                dep.codPersona,
                                                              ),
  ...
  void _executeReportDownload(
    BuildContext context,
    WidgetRef ref,
    _ReporteOption option,
  ) async {
    Future<Uint8List> downloadFunction() async {
  ...
  Widget _buildSingleReportButton(
    BuildContext context,
    WidgetRef ref,
    _ReporteOption option,
  ) {
