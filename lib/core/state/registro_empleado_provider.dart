...
final getListaEmpleados  = FutureProvider.family<List<EmpleadoEntity>,(String?,int?,int,int,int?)>((ref,params)async{
  final repo = RegistroEmpleadoImpl();
  final empleados = await repo.getLstEmpleados(params.$1, params.$2,params.$3,params.$4,params.$5);
  return empleados;
});
//Provider para registrar empleado
final registrarEmpleadoProvider = FutureProvider.family<EmpleadoEntity, EmpleadoEntity>((ref, empleado) async {
  final repo = RegistroEmpleadoImpl();
  final registrado = await repo.registrarEmpleado(empleado);
  return registrado;
});
//provider para obtener la lista de personas que no son empleados
final getLstPersona = FutureProvider.family<List<PersonaEntity>,String>((ref,buscarPersona)async{
  final repo = RegistroEmpleadoImpl();
...
final ciudadesCombinadasProvider = FutureProvider<List<CiudadEntity>>((ref) async {
...
final registrarEducacionProvider = FutureProvider.family<EducacionEntity, EducacionEntity>((ref, educacion) async {
  final repo = RegistroEmpleadoImpl();
  final registrado = await repo.registrarEducacion(educacion);
  return registrado;
});
//provider para obtener la lista de educacion de un empleado
final educacionProvider = FutureProvider.family<List<EducacionEntity>,int>((ref, codEmpleado)async{
 final repo = RegistroEmpleadoImpl();
...
final cargoXsucursalProvider = FutureProvider.family<List<CargoSucursalEntity>,int>((ref, codSucursal)async{
 final repo = RegistroEmpleadoImpl();
  final cargoXSuc = await repo.obtenerCargoXsucursal(codSucursal);
  return cargoXSuc;
});
//REGISTRAR RELACION LABORAL
final registrarRelacionLaboral = FutureProvider.family<RelacionLaboralEntity, RelacionLaboralEntity>((ref, relacion) async {
  final repo = RegistroEmpleadoImpl();
...
//provider para obtener la lista de tipos de educacion
final getTipoRelacionLaboral= FutureProvider<List<TipoRelacionLaboralEntity>>((ref) async {
  final repo = RegistroEmpleadoImpl();
...
final tempTelefonoListProvider = StateProvider<List<TelefonoEntity>>((ref) => []);
...
final registrarEmpleadoCargoProvider = FutureProvider.family<EmpleadoCargoEntity, EmpleadoCargoEntity>((ref, empleadoCargo) async {
  final repo = RegistroEmpleadoImpl();
  final registrarCargo = await repo.registroEmpleadoCargo(empleadoCargo);
  return registrarCargo;
});
final registroCuentaBancaria = FutureProvider.family<NroCuentaBancariaEntity, NroCuentaBancariaEntity>((ref, nroCuenta) async {
  final repo = RegistroEmpleadoImpl();
...
final cuentaBancariaEmpleadoProvider = FutureProvider.family<List<NroCuentaBancariaEntity>,int>((ref, codEmpleado)async{
 final repo = RegistroEmpleadoImpl();
...
final getHistorialCargosEmpleado = FutureProvider.family<List<EmpleadoEntity>,int>((ref, codEmpleado)async{
 final repo = RegistroEmpleadoImpl();
  final cargos = await repo.obtenerHistorialCargosEmpleado(codEmpleado);
  return cargos;
}); 
//obtener el historial de cargos de un empleado
final getHistorialRelLabEmpleado = FutureProvider.family<List<RelacionLaboralEntity>,int>((ref, codEmpleado)async{
 final repo = RegistroEmpleadoImpl();
  final relacion = await repo.obtenerHistorialRelLabEmpleado(codEmpleado);
  return relacion;
});
//provider para eliminar una cuenta bancaria por su codigo
final eliminarEmpleadoCargo = FutureProvider.family<void, (int,int,DateTime,int)>(
  (ref, params,) async {
    final repo = RegistroEmpleadoImpl();
    await repo.eliminarEmpleadoCargo(params.$1, params.$2, params.$3, params.$4);
  },
);
//obtener ultima relacion laboral de un empleado
final obtenerUltimaRelacionLaboralProvider = FutureProvider.family<RelacionLaboralEntity, int>(
...
final obtenerLicenciasConducirProvider = FutureProvider.family<List<LicenciaConducirEntity>, int>(
  (ref, codPersona) async {
    final repo = RegistroEmpleadoImpl();
...
final registrarLicenciaConducirProvider = FutureProvider.family<LicenciaConducirEntity, LicenciaConducirEntity>((ref, licencia) async {
  final repo = RegistroEmpleadoImpl();
...
final eliminarLicenciaConducirProvider = FutureProvider.family<void, int>(
  (ref, codLicencia) async {
    final repo = RegistroEmpleadoImpl();
    await repo.eliminarLicenciaConducir(codLicencia);
  },
);
//OBTENER TIPOS DE LICENCIA DE CONDUCIR
final obtenerTipoLicenciaConducirProvider = FutureProvider<List<TipoLicenciaEntity>>(
  (ref) async {
    final repo = RegistroEmpleadoImpl();
...
//provider para obtener la lista de empleados con filtros
final getCargoXEmpresa  = FutureProvider.family<List<EmpleadoEntity>,(String?,int?)>((ref,params)async{
  final repo = RegistroEmpleadoImpl();
...
final obtenerAfiliacionSeguro = FutureProvider.family<AfiliacionSeguroEntity?, int>((
  ref,
  codEmpleado,
) async {
  final repo = RegistroEmpleadoImpl();
...
final registrarAfiliacionSeguro = FutureProvider.family<AfiliacionSeguroEntity, AfiliacionSeguroEntity>((ref, afiliacion) async {
  final repo = RegistroEmpleadoImpl();
