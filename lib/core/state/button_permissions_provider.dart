...
final buttonPermissionsProvider = StateNotifierProvider<
  ButtonPermissionsNotifier,
  AsyncValue<List<UsuarioBtnEntity>>
>((ref) {
...
class ButtonPermissionsNotifier
    extends StateNotifier<AsyncValue<List<UsuarioBtnEntity>>> {
  final Ref _ref;
  ...
  Future<void> _loadPermisos() async {
    console("Cargando permisos de botones...");
    try {
      ...
      if (_ref.read(userProvider) != null) {
        ...
        console("El usuario se desconectó durante la carga de permisos");
        state = const AsyncValue.data([]);
      }
    } catch (e) {
      console("Error al cargar permisos: $e");
