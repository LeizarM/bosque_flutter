...
CombustibleControlModel combustibleControlModelFromJson(String str) =>
    CombustibleControlModel.fromJson(json.decode(str));

String combustibleControlModelToJson(CombustibleControlModel data) =>
...
class CombustibleControlModel {
  ...
  factory CombustibleControlModel.fromJson(Map<String, dynamic> json) =>
      CombustibleControlModel(
        idC: json["idC"] ?? 0,
