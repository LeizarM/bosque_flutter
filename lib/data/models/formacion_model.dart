...
List<FormacionModel> formacionModelFromJson(String str) =>
    List<FormacionModel>.from(
      json.decode(str).map((x) => FormacionModel.fromJson(x)),
    );

String formacionModelToJson(List<FormacionModel> data) =>
...
class FormacionModel {
  ...
  factory FormacionModel.fromJson(Map<String, dynamic> json) => FormacionModel(
    ...
    // fechaFormacion:
    //     json["fechaFormacion"] != null
    //         ? DateTime.parse(json["fechaFormacion"])
    //         : DateTime.now(),
    fechaFormacion:
        json["fechaFormacion"] != null
            ? DateTime.tryParse(json["fechaFormacion"])
            : null,
  ...
  Map<String, dynamic> toJson() => {
    ...
    // "fechaFormacion":
    //     "${fechaFormacion.year.toString().padLeft(4, '0')}-${fechaFormacion.month.toString().padLeft(2, '0')}-${fechaFormacion.day.toString().padLeft(2, '0')}",
