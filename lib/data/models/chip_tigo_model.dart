...
ChipTigoResponse chipTigoResponseFromJson(String str) =>
    ChipTigoResponse.fromJson(json.decode(str));

String chipTigoResponseToJson(ChipTigoResponse data) =>
  ...
  factory ChipTigoModel.fromJson(Map<String, dynamic> json) => ChipTigoModel(
    ...
    totalPaginas:
        json["totalPaginas"] != null
            ...
            : (json["total_paginas"] != null
                ? (json["total_paginas"] as num).toInt()
                : (json["TotalPaginas"] != null
                    ? (json["TotalPaginas"] as num).toInt()
                    : 1)),
  );
